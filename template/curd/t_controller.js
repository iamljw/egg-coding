...
module.exports = {
    ...
    build(data) {
        ...
        const createRule = require('../rules/student.json').create;
        const createManyRule = require('../rules/student.json').createMany;
        const deleteManyRule = require('../rules/student.json').deleteMany;
        const updateManyRule = require('../rules/student.json').updateMany;
        const updateRule = require('../rules/student.json').update;
